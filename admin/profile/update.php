...
<body>
    ...
    <?php
        ...
        if(isset($_POST['submit-update-profile'])) {
            ...
            $sql = "UPDATE admins 
                    SET username = '{$user}', password = '{$psw}', name = '{$name}', 
                        role = '{$role}'
                    WHERE admin_id = '{$admin_id}'";
            ...
            <div class="row">
                <div class="col min-vh-100 p-4">
                    ...
                    <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 py-4">
                        ...
                        <p>To Edit A New Profile, Please Fill In The Form Below!</p>

                        <div class="card">
                            <div class="card-body">
                                <form action="<?php $_SERVER['PHP_SELF'] ?>" method="post" enctype="multipart/form-data">
                                    <div class="mb-3">
                                        <input type="hidden" name="admin_id" class="form-control" value="<?php echo $admin_id ?>" placeholder="Admin ID">
                                    </div>
                                    <div class="mb-3">
                                        <label>Username</label>
                                        <input type="text" name="username" class="form-control" value="<?php echo $user ?>" placeholder="Username">
                                    </div>
                                    <div class="mb-3">
                                        <label>Password</label>
                                        <input type="text" name="password" class="form-control" value="<?php echo $psw ?>" placeholder="Password">
                                    </div>
                                    <div class="mb-3">
                                        <label>Name</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <?php 
                                            if($role == 1){
                                                echo "<option value='0'>Author</option>
                                                    <option value='1' selected>Admin</option>";
                                            } else{
                                                echo "<option value='0' selected>Author</option>
                                    ...
                                    <div>
                                        ...
                                        <button type="submit" name="submit-update-profile" class="btn btn-block btn-primary my-3" style="color: white;">
                                            Save
                                        </button>
                                    </div>
                                </form>
